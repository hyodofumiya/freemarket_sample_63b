...
ladys_grandchild_leg_wear_name_array = ['ソックス','スパッツ/レギンス','ストッキング/タイツ','レッグウェーマー','その他']
...
mens_grandchild_jakets_name_array = ['テーラードジャケット','ノーカラージャケット','Gジャン/デニムジャケット','レザージャケット','ダウンジャケット','ライダースジャケット','ミリタリージャケット','ナイロンジャケット','フライトジャケット','ダッフルコート','ピーコート','ステンカラーコート','トレンチコート','モッズコート','テェスターコート','スタジャン','ブルゾン','マウンテンパーカー','ダウンベスト','ポンチョ','カバーオール','その他']
...
mens_grandchild_small_article_name_array = ['長財布','折り財布','マネークリップ','コインケース/小銭入れ','名刺入れ/定期入れ','キーケース','キーホルダー','ネクタイ','手袋','ハンカチ','ベルト','マフラー','ストール','バンダナ','ネックウォーマー','サスペンダー','ウォレットテェーン','サングラス/メガネ','モバイルケース/カバー','手帳','ストラップ','ネクタイピン','カフリンクス','イラーマフラー','傘','レインコートー','ミラー','タバコグッズ','その他']
...
interior_grandchild_kitchen_name_array = ['食器','調理器具','収納/キッチン雑貨','弁当用品','カラトリー(スプーン等)','テーブル用品','容器','エプロン','アルコールグッズ','浄水器','その他']
...
cosme_perfume_beauty_grandchild_nail_care_name_array = ['ネイルカラー','カラージェル','ネイルベースコート/トップコート','ネイルアート用品','ネイルパーツ','ネイルチップ/付け爪','手入れ用ぐ','除光液','その他']
...
ladys_grandchild_array.push(ladys_grandchild_tops_array,ladys_grandchild_jakets_outer_array,ladys_grandchild_pants_array,ladys_grandchild_skirts_array,ladys_grandchild_one_piece_array,ladys_grandchild_shoes_array,ladys_grandchild_room_wear_array,ladys_grandchild_leg_wear_array,ladys_grandchild_hat_array,ladys_grandchild_bag_array,ladys_grandchild_accessory_array,ladys_grandchild_small_article_array,ladys_grandchild_watch_array,ladys_grandchild_wig_array,ladys_grandchild_yukata_swimwear_array,ladys_grandchild_suit_dress_array,ladys_grandchild_maternity_array,ladys_grandchild_others_array)
